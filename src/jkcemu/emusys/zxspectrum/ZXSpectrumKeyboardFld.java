 ...
 *
 * Komponente fuer die ZXSpectrum-Tastatur
 */
...
public class ZXSpectrumKeyboardFld extends AbstractKeyboardFld<ZXSpectrum>
{
  ...
  public ZXSpectrumKeyboardFld( ZXSpectrum spectrum )
  {
    ...
    this.fontLarge       = new Font( "SansSerif", Font.BOLD, FONT_LARGE_H );
    this.fontLetter      = new Font( "SansSerif", Font.BOLD, FONT_LETTER_H );
    this.fontStd         = new Font( "SansSerif", Font.PLAIN, FONT_H );
  ...
  {
    return super.getImage( "/images/keyboard/zxspectrum/" + filename );
  }
