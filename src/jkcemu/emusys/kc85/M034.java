 ...
 *
 * Emulation des RAM-Moduls M034 (512 KByte Segmented RAM)
 */
...
public class M034 extends AbstractKC85Module
{
  ...
  public M034( int slot )
  {
    super( slot );
    this.baseAddr  = 0;
    this.segMask   = 0;
    this.readwrite = false;
    this.ram       = new byte[ 0x80000 ];
  }
