...
public class CopyQMFloppyDisk extends AbstractFloppyDisk
{
  ...
  public static CopyQMFloppyDisk readFile(
				Frame owner,
				File  file ) throws IOException
  {
    CopyQMFloppyDisk rv    = null;
    InputStream      in    = null;
	...
	if( (len & 0x8000) != 0 ) {
      ...
      // FloppyDisk-Object anlegen
      rv = new CopyQMFloppyDisk(
				owner,
				sides,
				cyls,
				sectorsPerCyl,
