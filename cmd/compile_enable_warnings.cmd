...
REM (c) 2017-2020 Jens Mueller
REM
REM Dieses Skript kompiliert JKCEMU mit eingeschalteten Warnungen.
REM Die einzige nicht eingeschaltete Warnung ist die Pruefung
REM auf eine gesetzte serialVersionUID.
REM Dies ist in JKCEMU nicht noetig,
REM da die Objektserialisierung nicht genutzt wird.
REM
REM Die Schalter fuer die Warnungen sind keine Standard-Java-Optionen.
REM Aus diesem Grund kann nicht garantiert werden,
REM dass dieses Skript mit allen Java-Compiler laeuft.
